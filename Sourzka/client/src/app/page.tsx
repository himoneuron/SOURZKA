...
//import GstinVerification from '../components/GstinVerification'; // Import the component
//src//app//components//gstinverification
import GstinVerification from './components/GstinVerification';
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center w-full">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 w-full max-w-xl">
          <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800 dark:text-gray-200">
            Manufacturer GSTIN Verification
          </h2>
          <p className="mb-4 text-center text-sm text-gray-600 dark:text-gray-400">
            If you are a manufacturer, you can verify your GSTIN using the tool below.
            This is a demonstration component.
          </p>
          <GstinVerification initialVerifiedName={null} />
        </div>
      </main>
